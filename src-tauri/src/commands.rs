...
/// Live visible text of a pane, for Approve all's last-moment check.
#[tauri::command]
pub fn grid_screen_text(grids: State<'_, GridManager>, id: String) -> Result<String, String> {
    grids.screen_text(&id)
}
