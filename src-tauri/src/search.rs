...
mod tests {
    ...
    fn finds_a_single_match_with_correct_column() {
        ...
        assert_eq!(hits, vec![Match { line: 0, col: 6, len: 5 }]);
    }
    ...
    fn finds_multiple_non_overlapping_matches_in_one_line() {
        ...
        assert_eq!(
            hits,
            vec![
                Match { line: 0, col: 0, len: 2 },
                Match { line: 0, col: 2, len: 2 },
                Match { line: 0, col: 4, len: 2 },
            ]
        );
    }
    ...
    fn reports_matches_across_lines_with_history_indices() {
        ...
        assert_eq!(
            hits,
            vec![
                Match { line: -2, col: 0, len: 5 },
                Match { line: 0, col: 8, len: 5 },
            ]
        );
    }
    ...
    fn finds_hebrew_substring_by_column() {
        ...
        assert_eq!(hits, vec![Match { line: 0, col: 5, len: 4 }]);
    }
